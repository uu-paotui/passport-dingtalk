...
function Strategy(options, verify) {
  options = options || {}
  options.authorizationURL = options.authorizationURL || 'https://login.dingtalk.com/oauth2/auth'
  ...
  this.name = 'dingtalk'
  this._oauth2._userProfileURL = options.userProfileURL || 'https://api.dingtalk.com/v1.0/contact/users/me'
  this._oauth2._persistentTokenURL = options.persistentTokenURL || 'https://api.dingtalk.com/v1.0/oauth2/userAccessToken '
  ...
  this._oauth2.getOAuthAccessToken = function (code, params, callback) {
    var self = this
    urllib.request(this._persistentTokenURL, {
      headers: {
        'Content-Type': 'application/json'
      },
      method: 'POST',
      ...
      if (!accessToken|| !refreshToken) return callback(new Error('refreshToken failed'))
...
Strategy.prototype.userProfile = function(params,done,accessToken) {
  urllib.request(this._oauth2._userProfileURL, {
    headers: {
      'Content-Type': 'application/json',
